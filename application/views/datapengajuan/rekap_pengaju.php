                         ...
                         <?php
                            ...
                            foreach ($penelitian as $key => $obj) {
                                ...
                                if ($id_kategori == 3) {
                                    ...
                                    $thn_sekarang = date("Y");
                                    //echo $id_user = $this->session->userdata('id_user');
                            ...
                            ?>
                             <tr>
                                 ...
                                 <td><?= $nm_pub ?></td>
                                 <td></td>
                                 <td><button type="button" class="btn btn-block btn-success btn-xs" onclick="location.href='<?php echo base_url("Datapengajuan/detail/$id_kategori/$st_publikasi/$id_pengajuan/$id_user"); ?>'">Detail</button></td>
                             </tr>
